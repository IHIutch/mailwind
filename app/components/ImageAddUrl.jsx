          ...
          <div className="w-full">
            <div className="relative flex items-end">
              ...
              <input
                ...
                className="grow rounded-md border-zinc-300 pl-10 pr-24 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
              />
              <div className="absolute inset-y-0 right-0 flex w-24 items-center justify-center px-1">
                <button
                  onClick={handleSubmit}
                  className="w-full cursor-pointer rounded-md bg-indigo-500 py-2 px-4 text-sm font-semibold text-white hover:bg-indigo-600"
                >
                  Submit
                </button>
              </div>
